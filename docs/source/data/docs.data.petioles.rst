...
+---------------------------------+------------------------------------+
| Detector Name                   |        FLIR Epics                  |
+---------------------------------+------------------------------------+
| Pixel Size                      |        0.635 µm                    |
+---------------------------------+------------------------------------+
| Detector Dimension x            |        2560                        |
+---------------------------------+------------------------------------+
| Detector Dimension y            |        690                         |
+---------------------------------+------------------------------------+
...
*   **Expert-curated Masks**: :download:`annotations.tar.zst <https://zenodo.org/records/19476729/files/annotations.tar.zst>` - Semantic instances for 42 cross-sections (xylem, parenchyma, embolized vessels).
